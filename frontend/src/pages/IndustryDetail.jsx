...
export default function IndustryDetail() {
  ...
  if (err) return (
    <div className="bg-white min-h-screen" data-testid="industry-error">
      <BoldNavbar />
    ...
    <div className="bg-white min-h-screen text-[#1a1a1a] font-nunito" data-testid={`industry-detail-${slug}`}>
      ...
      <section className="max-w-7xl mx-auto px-4 lg:px-6 py-8 grid lg:grid-cols-12 gap-6">
        <button
          ...
          data-testid="industry-mobile-filter-toggle"
        >
        ...
        <div className="lg:col-span-9" data-testid="industry-results">
          {products.length === 0 ? (
            ...
            <>
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4" data-testid="industry-products-grid">
                {products.map((p) => {
