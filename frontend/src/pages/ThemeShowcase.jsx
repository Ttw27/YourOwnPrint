...
import Theme2BBrand from "../components/themes/Theme2BBrand";
...
export default function ThemeShowcase() {
  return (
    <div data-testid="theme-showcase">
      ...
      <div className="bg-black text-white border-b border-neutral-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="flex gap-2 text-xs flex-wrap">
            ...
            <a href="#theme-2b" className="px-3 py-1.5 bg-[#FFD60A] text-black font-bold uppercase tracking-wider hover:opacity-90">2B YOP Brand</a>
      ...
      <div id="theme-2b"><Theme2BBrand inShowcase={true} themeNumber="2B" /></div>
