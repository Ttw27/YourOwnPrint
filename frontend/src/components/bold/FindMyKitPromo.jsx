 ...
 */
export default function FindMyKitPromo({ variant = "inline", trade = "", className = "" }) {
  ...
  if (variant === "hero") {
    return (
      <section className={`px-6 ${className}`} data-testid="fmk-promo-hero">
        <div className="max-w-6xl mx-auto bg-gradient-to-br from-[#7bc67e] to-[#5eb062] rounded-[2rem] px-8 py-12 sm:px-14 sm:py-14 text-[#1a1a1a] relative overflow-hidden">
          <div className="absolute -top-8 -right-8 w-40 h-40 bg-white/15 rounded-full" />
